...
def sendToStatsd(key, value):
    ...
    #print("%s Sending to statsd - %s:%s") % (strftime("%d %b %Y %H:%M:%S", gmtime()), key, value) if verbose
...
if __name__ == '__main__':
    ...
    if ENV == 'prod':
        ...
        GRAYLOG_API_HOST = os.environ['GRAYLOG_HOST_PROD']
        GRAYLOG_API_PORT = os.environ['GRAYLOG_PORT_PROD']
